...
constexpr const char* kFRStudent1Namespace = "fr.gouv.education.1";
...
constexpr const char* kSupportedNamespaces[] = {
    ...
    kISO23220DTCNamespace, kFRANTSMDL1Namespace, kFRStudent1Namespace};
...
constexpr const char* kFRStudentDocType = "fr.gouv.education.1.student";
...
constexpr MdocAttribute kMdocAttributes[] = {
    ...
    // {"university_name", kFRStudent1Namespace},
    // {"university_address", kFRStudent1Namespace},
    // {"university_city", kFRStudent1Namespace},
    // {"university_postal_code", kFRStudent1Namespace},
    // {"university_country", kFRStudent1Namespace},
};
